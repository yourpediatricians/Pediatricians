  ...
  return (
    <section>
      <div className="container my-5">
        ...
        <p className="mb-5" style={{fontSize: '1.2em'}}>All Blueberry pediatricians are board-certified by the American Board of Pediatrics and have many years of experience providing medical care for kids, from newborn all the way to 21!</p>
